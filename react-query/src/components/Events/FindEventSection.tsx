...
export default function FindEventSection() {
  ...
  const { data, isLoading, isError, error } = useQuery<EventType[], FetchError, EventType[], [string, { searchTerm?: string }]>({
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (searchElement.current) setSearchTerm(searchElement.current.value);
  }
